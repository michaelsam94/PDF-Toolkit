...
android {
  namespace = "com.michael.pdftoolkit"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "com.michael.pdftoolkit"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  testOptions {
    unitTests {
      ...
      all {
        ...
        it.useJUnit {
          if (screenshotTests) {
            includeCategories("com.michael.pdftoolkit.playstore.PlayStoreScreenshotTests")
          } else {
            excludeCategories("com.michael.pdftoolkit.playstore.PlayStoreScreenshotTests")
          }
        }
      }
    }
